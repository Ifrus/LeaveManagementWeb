        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, Roles.User); //assign to new account the user role 
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email", //implement email service
