        ...
        public async Task<IActionResult> Create(LeaveRequestCreateVM model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "You have exceeded your allocation with this report.");
                }
            }
            catch(Exception ex)
            {
                ModelState.AddModelError(string.Empty, "An Error Hass Occurred. Please Try Again Later.");
            }
